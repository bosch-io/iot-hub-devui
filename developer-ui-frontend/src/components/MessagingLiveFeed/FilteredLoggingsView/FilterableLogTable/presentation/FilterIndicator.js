...
import TelemetryIcon from "images/telemetryIcon.svg";
// import DeviceIdIcon from "images/deviceIcon.svg";  TODO: Currently there is a bug in react-svg-loader and this doesn't work. FIX THIS LATER! https://github.com/boopathi/react-svg-loader/issues/197
const DeviceIdIcon = (
  <svg
...
import CurlyBraceIcon from "images/curlyBraceIcon.svg";
import XmlIcon from "images/xmlIcon.svg";
import DefaultIcon from "images/defaultIcon.svg";
import UnknownCategoryIcon from "images/unknownCategoryIcon.svg";
import CancelIcon from "images/cancelIcon.svg";

/**
 * A small box with an icon (marking the filter type), a value and a delete (x) button.
 *
 * @author Tim Weise
 * @version 0.1.0
 */
export default class FilterIndicator extends React.Component {
  constructor(props) {
    super(props);
  ...
  getIcon() {
    ...
    switch (category) {
      case "Type":
        ...
        break;
      case "Device Id":
        icon = DeviceIdIcon; // <DeviceIdIcon />
        break;
      case "Content-Type":
  ...
  handleClick() {
    const filterId = calculateFilterId(this.props.category, this.props.value);
...
FilterIndicator.propTypes = {
  /**
   * The category of the FilterIndicator (used to determine the corresponding icon)
   */
  // category: PropTypes.oneOf(FILTER_CATEGORIES).isRequired,
  category: PropTypes.string.isRequired,
  /**
   * The value of the FilterIndicator
   */
